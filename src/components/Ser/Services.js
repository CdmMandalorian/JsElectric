        ...
        <Container className="services-content" >
          ...
          <Row style={{ justifyContent: "center", paddingBottom: "10px" }}>
            ...
            <Servicescard className="LongServiceCard"
                  ...
                  description="Wiring a home properly is an important part of maintaining a safe environment and providing a worry-free experience when working with electricity. Not only does proper wiring ensure the smooth functioning of a home's electrical supply to connected appliances; it also protects the house from any kind of electrical hazard..."
                  descriptionB="With today's higher energy consumption, it is imperative your home's wiring is up to date. Contact us Today, to find out if your house requires new House Rewiring."
                  imgPath={Bolt}
              >
                <Accordion id ="accord"></Accordion> 
              </Servicescard>
            </Col>
            ...
            <Servicescard className="LongServiceCard"
                ...
                descriptionB="At the root of comfort is the dependency of knowing that all your electrical needs are being meet with the upmost safety standards. An electical panel is what controls this aspect and lets us incorporate new technologies into our home. When an electrical panel is damaged, not only does it compromise your appliances, but also the safety of everyone within your home. Call me for an inspection."
                imgPath={Columns}
              >
                <Accordion id ="accord"></Accordion>
              </Servicescard> 
            ...
            <Servicescard className="LongServiceCard"
                ...
                descriptionB="Ideally for new electrical current lines for garages, guest homes, patios, backyards, attics, basement etc,,. If a sub panel would be installed on detached dwelling, then it would be required to have its on grounding system. The grounding system would consist of a conductor branched off the grounding bar in the panel ending with an 8'ft ground rod driven into the earth."
